...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,5),I=0,4) /13,-1, 1,-1, 1/
      DATA (NHEL(I,6),I=0,4) /14,-1, 1,-1,-1/
      DATA (NHEL(I,7),I=0,4) /15,-1, 1, 1, 1/
      DATA (NHEL(I,8),I=0,4) /16,-1, 1, 1,-1/
      DATA IDEN/36/
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WXm) 
      ...
      CALL OXXXXX(P(0,3),MDL_MXM,+1,+1*IC(3),W(1,5))  !  count 4
      CALL OXXXXX(P(0,3),MDL_MXM,-1,+1*IC(3),W(1,6))  !  count 4
      CALL IXXXXX(P(0,4),MDL_MXM,+1,-1*IC(4),W(1,7))  !  count 4
      CALL IXXXXX(P(0,4),MDL_MXM,-1,-1*IC(4),W(1,8))  !  count 4
      CALL FFV1P0_3(W(1,1),W(1,4),GC_11(IVEC),ZERO,FK_ZERO,W(1,9))  !  count 4
      CALL FFV1P0_3(W(1,2),W(1,3),GC_11(IVEC),ZERO,FK_ZERO,W(1,10))  !  count 4
      CALL FFV1P1N_1(W(1,5), W(1,9), GC_11(IVEC), TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
     ...
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,6), W(1,9), GC_11(IVEC), TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
