...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,1),I=0,4) /2,-1,-1,-1,-1/
      DATA (NHEL(I,2),I=0,4) /3,-1,-1, 1, 1/
      DATA (NHEL(I,3),I=0,4) /5,-1, 1,-1, 1/
      DATA (NHEL(I,4),I=0,4) /6,-1, 1,-1,-1/
      DATA (NHEL(I,5),I=0,4) /7,-1, 1, 1, 1/
      DATA (NHEL(I,6),I=0,4) /8,-1, 1, 1,-1/
      DATA (NHEL(I,7),I=0,4) /9, 1,-1,-1, 1/
      DATA (NHEL(I,8),I=0,4) /10, 1,-1,-1,-1/
      DATA (NHEL(I,9),I=0,4) /11, 1,-1, 1, 1/
      DATA (NHEL(I,10),I=0,4) /12, 1,-1, 1,-1/
      DATA (NHEL(I,11),I=0,4) /14, 1, 1,-1,-1/
      DATA (NHEL(I,12),I=0,4) /15, 1, 1, 1, 1/
      DATA IDEN/256/
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WXm) 
      ...
      CALL OXXXXX(P(0,3),MDL_MXM,+1,+1*IC(3),W(1,5))  !  count 14
      CALL OXXXXX(P(0,3),MDL_MXM,-1,+1*IC(3),W(1,6))  !  count 14
      CALL IXXXXX(P(0,4),MDL_MXM,+1,-1*IC(4),W(1,7))  !  count 14
      CALL IXXXXX(P(0,4),MDL_MXM,-1,-1*IC(4),W(1,8))  !  count 14
      CALL VVV1P0_1(W(1,1),W(1,3),GC_10(IVEC),ZERO,FK_ZERO,W(1,9))  !  count 2
      CALL VVV1P0_1(W(1,1),W(1,4),GC_10(IVEC),ZERO,FK_ZERO,W(1,10))  !  count 4
      CALL VVV1P0_1(W(1,2),W(1,3),GC_10(IVEC),ZERO,FK_ZERO,W(1,11))  !  count 4
      CALL VVV1P0_1(W(1,2),W(1,4),GC_10(IVEC),ZERO,FK_ZERO,W(1,12))  !  count 2
      CALL FFV1P1N_3(W(1,7), W(1,5), GC_11(IVEC), TMP(1))
      call CombineAmp(4,
     & (/12,9,5,2/), 
     & (/9,10,11,12/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_3(W(1,7), W(1,6), GC_11(IVEC), TMP(1))
      call CombineAmp(2,
     & (/7,3/), 
     & (/10,11/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_3(W(1,8), W(1,5), GC_11(IVEC), TMP(1))
      call CombineAmp(2,
     & (/10,6/), 
     & (/10,11/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_3(W(1,8), W(1,6), GC_11(IVEC), TMP(1))
      call CombineAmp(4,
     & (/11,8,4,1/), 
     & (/9,10,11,12/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1_1(W(1,5),W(1,1),GC_11(IVEC),MDL_MXM,ZERO,W(1,13))  !  count 3
      CALL FFV1_1(W(1,5),W(1,2),GC_11(IVEC),MDL_MXM,ZERO,W(1,14))  !  count 3
      CALL FFV1_1(W(1,6),W(1,1),GC_11(IVEC),MDL_MXM,ZERO,W(1,15))  !  count 3
      CALL FFV1_1(W(1,6),W(1,2),GC_11(IVEC),MDL_MXM,ZERO,W(1,16))  !  count 3
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV1_2(W(1,7),W(1,1),GC_11(IVEC),MDL_MXM,ZERO,W(1,17))  !  count 3
      CALL FFV1_2(W(1,7),W(1,2),GC_11(IVEC),MDL_MXM,ZERO,W(1,18))  !  count 3
      CALL FFV1_2(W(1,8),W(1,1),GC_11(IVEC),MDL_MXM,ZERO,W(1,19))  !  count 3
      CALL FFV1_2(W(1,8),W(1,2),GC_11(IVEC),MDL_MXM,ZERO,W(1,20))  !  count 3
