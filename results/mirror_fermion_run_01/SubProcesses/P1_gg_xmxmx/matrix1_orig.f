...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WXM)
      ...
      CALL OXXXXX(P(0,3),MDL_MXM,NHEL(3),+1*IC(3),W(1,3))
      CALL IXXXXX(P(0,4),MDL_MXM,NHEL(4),-1*IC(4),W(1,4))
      CALL VVV1P0_1(W(1,1),W(1,2),GC_10(IVEC),ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_11(IVEC),AMP(1))
      CALL FFV1_1(W(1,3),W(1,1),GC_11(IVEC),MDL_MXM, ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,4),W(1,5),W(1,2),GC_11(IVEC),AMP(2))
      CALL FFV1_2(W(1,4),W(1,1),GC_11(IVEC),MDL_MXM, ZERO,W(1,5))
