...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,1),I=0,4) /1, 1,-1,-1, 1/
      DATA (NHEL(I,2),I=0,4) /2, 1,-1,-1,-1/
      DATA (NHEL(I,3),I=0,4) /3, 1,-1, 1, 1/
      DATA (NHEL(I,4),I=0,4) /4, 1,-1, 1,-1/
      DATA (NHEL(I,5),I=0,4) /5, 1, 1,-1, 1/
      DATA (NHEL(I,6),I=0,4) /6, 1, 1,-1,-1/
      DATA (NHEL(I,7),I=0,4) /7, 1, 1, 1, 1/
      DATA (NHEL(I,8),I=0,4) /8, 1, 1, 1,-1/
      DATA (NHEL(I,9),I=0,4) /9,-1,-1,-1, 1/
      DATA (NHEL(I,10),I=0,4) /10,-1,-1,-1,-1/
      DATA (NHEL(I,11),I=0,4) /11,-1,-1, 1, 1/
      DATA (NHEL(I,12),I=0,4) /12,-1,-1, 1,-1/
      DATA (NHEL(I,13),I=0,4) /13,-1, 1,-1, 1/
      DATA (NHEL(I,14),I=0,4) /14,-1, 1,-1,-1/
      DATA (NHEL(I,15),I=0,4) /15,-1, 1, 1, 1/
      DATA (NHEL(I,16),I=0,4) /16,-1, 1, 1,-1/
      DATA IDEN/36/
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WXm) 
      ...
      CALL OXXXXX(P(0,3),MDL_MXM,+1,+1*IC(3),W(1,5))  !  count 8
      CALL OXXXXX(P(0,3),MDL_MXM,-1,+1*IC(3),W(1,6))  !  count 8
      CALL IXXXXX(P(0,4),MDL_MXM,+1,-1*IC(4),W(1,7))  !  count 8
      CALL IXXXXX(P(0,4),MDL_MXM,-1,-1*IC(4),W(1,8))  !  count 8
      CALL FFV1P0_3(W(1,1),W(1,3),GC_11(IVEC),ZERO,FK_ZERO,W(1,9))  !  count 4
      CALL FFV1P0_3(W(1,1),W(1,4),GC_11(IVEC),ZERO,FK_ZERO,W(1,10))  !  count 4
      CALL FFV1P0_3(W(1,2),W(1,3),GC_11(IVEC),ZERO,FK_ZERO,W(1,11))  !  count 4
      CALL FFV1P0_3(W(1,2),W(1,4),GC_11(IVEC),ZERO,FK_ZERO,W(1,12))  !  count 4
