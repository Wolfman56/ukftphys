...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WT)
      ...
      CALL FFV1P0_3(W(1,1),W(1,2),GC_11(IVEC),ZERO, FK_ZERO,W(1,6))
      CALL FFS4_1(W(1,3),W(1,5),GC_94,MDL_MT, FK_MDL_WT,W(1,2))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,4),W(1,2),W(1,6),GC_11(IVEC),AMP(1))
      CALL FFS4_2(W(1,4),W(1,5),GC_94,MDL_MT, FK_MDL_WT,W(1,2))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,2),W(1,3),W(1,6),GC_11(IVEC),AMP(2))
