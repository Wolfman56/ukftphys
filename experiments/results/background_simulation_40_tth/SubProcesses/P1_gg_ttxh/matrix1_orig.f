...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WT)
      ...
      CALL VVV1P0_1(W(1,1),W(1,2),GC_10(IVEC),ZERO, FK_ZERO,W(1,6))
      CALL FFS4_1(W(1,3),W(1,5),GC_94,MDL_MT, FK_MDL_WT,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,4),W(1,7),W(1,6),GC_11(IVEC),AMP(1))
      CALL FFS4_2(W(1,4),W(1,5),GC_94,MDL_MT, FK_MDL_WT,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,8),W(1,3),W(1,6),GC_11(IVEC),AMP(2))
      CALL FFV1_1(W(1,3),W(1,1),GC_11(IVEC),MDL_MT, ZERO,W(1,6))
      CALL FFV1_2(W(1,4),W(1,2),GC_11(IVEC),MDL_MT, ZERO,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFS4_0(W(1,9),W(1,6),W(1,5),GC_94,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,8),W(1,6),W(1,2),GC_11(IVEC),AMP(4))
      CALL FFV1_2(W(1,4),W(1,1),GC_11(IVEC),MDL_MT, ZERO,W(1,6))
      CALL FFV1_1(W(1,3),W(1,2),GC_11(IVEC),MDL_MT, ZERO,W(1,4))
C     Amplitude(s) for diagram number 5
      CALL FFS4_0(W(1,6),W(1,4),W(1,5),GC_94,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,6),W(1,7),W(1,2),GC_11(IVEC),AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,8),W(1,4),W(1,1),GC_11(IVEC),AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,9),W(1,7),W(1,1),GC_11(IVEC),AMP(8))
