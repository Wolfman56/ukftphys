...
C     
C     Process: u u~ > h g HIG<=1 HIW<=1 WEIGHTED<=3 @1
C     *   Decay: h > ta- ta+ HIG<=1 HIW<=1 WEIGHTED<=2
C     Process: c c~ > h g HIG<=1 HIW<=1 WEIGHTED<=3 @1
C     *   Decay: h > ta- ta+ HIG<=1 HIW<=1 WEIGHTED<=2
C     Process: d d~ > h g HIG<=1 HIW<=1 WEIGHTED<=3 @1
C     *   Decay: h > ta- ta+ HIG<=1 HIW<=1 WEIGHTED<=2
C     Process: s s~ > h g HIG<=1 HIW<=1 WEIGHTED<=3 @1
C     *   Decay: h > ta- ta+ HIG<=1 HIW<=1 WEIGHTED<=2
C     
      IMPLICIT NONE
C     
...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,9),I=0,5) /25,-1, 1,-1, 1,-1/
      DATA (NHEL(I,10),I=0,5) /26,-1, 1,-1, 1, 1/
      DATA (NHEL(I,11),I=0,5) /27,-1, 1,-1,-1,-1/
      DATA (NHEL(I,12),I=0,5) /28,-1, 1,-1,-1, 1/
      DATA (NHEL(I,13),I=0,5) /29,-1, 1, 1, 1,-1/
      DATA (NHEL(I,14),I=0,5) /30,-1, 1, 1, 1, 1/
      DATA (NHEL(I,15),I=0,5) /31,-1, 1, 1,-1,-1/
      DATA (NHEL(I,16),I=0,5) /32,-1, 1, 1,-1, 1/
      DATA IDEN/36/
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WH) 
      ...
      CALL VXXXXX(P(0,5),ZERO,+1,+1*IC(5),W(1,13))  !  count 4
      CALL VXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,14))  !  count 4
      CALL VVS3P0_1(W(1,13),W(1,9),GC_13(IVEC),ZERO,FK_ZERO,W(1,15))  !  count 2
      CALL VVS3P0_1(W(1,13),W(1,10),GC_13(IVEC),ZERO,FK_ZERO,W(1,16))  !  count 2
      CALL VVS3P0_1(W(1,13),W(1,11),GC_13(IVEC),ZERO,FK_ZERO,W(1,17))  !  count 2
      CALL VVS3P0_1(W(1,13),W(1,12),GC_13(IVEC),ZERO,FK_ZERO,W(1,18))  !  count 2
      CALL VVS3P0_1(W(1,14),W(1,9),GC_13(IVEC),ZERO,FK_ZERO,W(1,19))  !  count 2
      CALL VVS3P0_1(W(1,14),W(1,10),GC_13(IVEC),ZERO,FK_ZERO,W(1,20))  !  count 2
      CALL VVS3P0_1(W(1,14),W(1,11),GC_13(IVEC),ZERO,FK_ZERO,W(1,21))  !  count 2
      CALL VVS3P0_1(W(1,14),W(1,12),GC_13(IVEC),ZERO,FK_ZERO,W(1,22))  !  count 2
      CALL FFV1P1N_3(W(1,1), W(1,4), GC_11(IVEC), TMP(1))
      call CombineAmp(8,
     & (/6,2,8,4,5,1,7,3/), 
     & (/15,16,17,18,19,20,21,22/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_3(W(1,2), W(1,3), GC_11(IVEC), TMP(1))
      call CombineAmp(8,
