...
C     
C     Process: g u > h u HIG<=1 HIW<=1 WEIGHTED<=3 @1
C     *   Decay: h > ta- ta+ HIG<=1 HIW<=1 WEIGHTED<=2
C     Process: g c > h c HIG<=1 HIW<=1 WEIGHTED<=3 @1
C     *   Decay: h > ta- ta+ HIG<=1 HIW<=1 WEIGHTED<=2
C     Process: g d > h d HIG<=1 HIW<=1 WEIGHTED<=3 @1
C     *   Decay: h > ta- ta+ HIG<=1 HIW<=1 WEIGHTED<=2
C     Process: g s > h s HIG<=1 HIW<=1 WEIGHTED<=3 @1
C     *   Decay: h > ta- ta+ HIG<=1 HIW<=1 WEIGHTED<=2
C     
      IMPLICIT NONE
C     
...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,1),I=0,5) /2,-1, 1,-1, 1, 1/
      DATA (NHEL(I,2),I=0,5) /4,-1, 1,-1,-1, 1/
      DATA (NHEL(I,3),I=0,5) /6,-1, 1, 1, 1, 1/
      DATA (NHEL(I,4),I=0,5) /8,-1, 1, 1,-1, 1/
      DATA (NHEL(I,5),I=0,5) /9,-1,-1,-1, 1,-1/
      DATA (NHEL(I,6),I=0,5) /11,-1,-1,-1,-1,-1/
      DATA (NHEL(I,7),I=0,5) /13,-1,-1, 1, 1,-1/
      DATA (NHEL(I,8),I=0,5) /15,-1,-1, 1,-1,-1/
      DATA (NHEL(I,9),I=0,5) /18, 1, 1,-1, 1, 1/
      DATA (NHEL(I,10),I=0,5) /20, 1, 1,-1,-1, 1/
      DATA (NHEL(I,11),I=0,5) /22, 1, 1, 1, 1, 1/
      DATA (NHEL(I,12),I=0,5) /24, 1, 1, 1,-1, 1/
      DATA (NHEL(I,13),I=0,5) /25, 1,-1,-1, 1,-1/
      DATA (NHEL(I,14),I=0,5) /27, 1,-1,-1,-1,-1/
      DATA (NHEL(I,15),I=0,5) /29, 1,-1, 1, 1,-1/
      DATA (NHEL(I,16),I=0,5) /31, 1,-1, 1,-1,-1/
      DATA IDEN/96/
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WH) 
      ...
      AMP(:,:) = (0d0,0d0)
            CALL VXXXXX(P(0,1),ZERO,+1,-1*IC(1),W(1,1))  !  count 4
      CALL VXXXXX(P(0,1),ZERO,-1,-1*IC(1),W(1,2))  !  count 4
      ...
      CALL FFS2_3(W(1,7),W(1,5),GC_86,MDL_MH,FK_MDL_WH,W(1,9))  !  count 2
      CALL FFS2_3(W(1,7),W(1,6),GC_86,MDL_MH,FK_MDL_WH,W(1,10))  !  count 2
      CALL FFS2_3(W(1,8),W(1,5),GC_86,MDL_MH,FK_MDL_WH,W(1,11))  !  count 2
      CALL FFS2_3(W(1,8),W(1,6),GC_86,MDL_MH,FK_MDL_WH,W(1,12))  !  count 2
      CALL OXXXXX(P(0,5),ZERO,+1,+1*IC(5),W(1,13))  !  count 8
      CALL OXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,14))  !  count 8
      CALL VVS3P0_1(W(1,1),W(1,9),GC_13(IVEC),ZERO,FK_ZERO,W(1,15))  !  count 2
      CALL VVS3P0_1(W(1,1),W(1,10),GC_13(IVEC),ZERO,FK_ZERO,W(1,16))  !  count 2
      CALL VVS3P0_1(W(1,1),W(1,11),GC_13(IVEC),ZERO,FK_ZERO,W(1,17))  !  count 2
      CALL VVS3P0_1(W(1,1),W(1,12),GC_13(IVEC),ZERO,FK_ZERO,W(1,18))  !  count 2
      CALL VVS3P0_1(W(1,2),W(1,9),GC_13(IVEC),ZERO,FK_ZERO,W(1,19))  !  count 2
      CALL VVS3P0_1(W(1,2),W(1,10),GC_13(IVEC),ZERO,FK_ZERO,W(1,20))  !  count 2
      CALL VVS3P0_1(W(1,2),W(1,11),GC_13(IVEC),ZERO,FK_ZERO,W(1,21))  !  count 2
      CALL VVS3P0_1(W(1,2),W(1,12),GC_13(IVEC),ZERO,FK_ZERO,W(1,22))  !  count 2
      CALL FFV1P1N_3(W(1,3), W(1,13), GC_11(IVEC), TMP(1))
      call CombineAmp(8,
     & (/11,9,12,10,3,1,4,2/), 
     & (/15,16,17,18,19,20,21,22/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_3(W(1,4), W(1,14), GC_11(IVEC), TMP(1))
      call CombineAmp(8,
     & (/15,13,16,14,7,5,8,6/), 
     & (/15,16,17,18,19,20,21,22/),
