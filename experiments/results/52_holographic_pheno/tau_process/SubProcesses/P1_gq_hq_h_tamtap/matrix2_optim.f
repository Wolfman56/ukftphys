...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WH) 
      ...
      CALL IXXXXX(P(0,5),ZERO,+1,-1*IC(5),W(1,13))  !  count 8
      CALL IXXXXX(P(0,5),ZERO,-1,-1*IC(5),W(1,14))  !  count 8
      ...
      CALL FFV1P1N_3(W(1,13), W(1,3), GC_11(IVEC), TMP(1))
      call CombineAmp(8,
     & (/15,13,16,14,7,5,8,6/), 
     & (/15,16,17,18,19,20,21,22/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_3(W(1,14), W(1,4), GC_11(IVEC), TMP(1))
      call CombineAmp(8,
     & (/11,9,12,10,3,1,4,2/), 
     & (/15,16,17,18,19,20,21,22/),
