...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WH)
      ...
      CALL FFS2_3(W(1,4),W(1,3),GC_86,MDL_MH, FK_MDL_WH,W(1,5))
      CALL VXXXXX(P(0,5),ZERO,NHEL(5),+1*IC(5),W(1,4))
C     Amplitude(s) for diagram number 1
      CALL VVVS2_0(W(1,1),W(1,2),W(1,4),W(1,5),GC_14(IVEC),AMP(1))
      CALL VVV1P0_1(W(1,1),W(1,2),GC_10(IVEC),ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL VVS3_0(W(1,4),W(1,3),W(1,5),GC_13(IVEC),AMP(2))
      CALL VVS3P0_1(W(1,1),W(1,5),GC_13(IVEC),ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 3
      CALL VVV1_0(W(1,2),W(1,4),W(1,3),GC_10(IVEC),AMP(3))
      CALL VVV1P0_1(W(1,1),W(1,4),GC_10(IVEC),ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 4
      CALL VVS3_0(W(1,2),W(1,3),W(1,5),GC_13(IVEC),AMP(4))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      JAMP(1,1) = ((0.000000000000000D+00,2.000000000000000D+00))
     $ *TMP_JAMP(3)
      JAMP(2,1) = ((0.000000000000000D+00,-2.000000000000000D+00))
     $ *TMP_JAMP(3)
