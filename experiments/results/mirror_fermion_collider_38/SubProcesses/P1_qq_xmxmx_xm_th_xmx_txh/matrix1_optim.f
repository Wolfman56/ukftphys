...
C     
C     Process: u u~ > xm xm~ WEIGHTED<=2 @1
C     *   Decay: xm > t h WEIGHTED<=2
C     *   Decay: xm~ > t~ h WEIGHTED<=2
C     Process: d d~ > xm xm~ WEIGHTED<=2 @1
C     *   Decay: xm > t h WEIGHTED<=2
C     *   Decay: xm~ > t~ h WEIGHTED<=2
C     Process: s s~ > xm xm~ WEIGHTED<=2 @1
C     *   Decay: xm > t h WEIGHTED<=2
C     *   Decay: xm~ > t~ h WEIGHTED<=2
C     
      IMPLICIT NONE
...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,5),I=0,6) /13,-1, 1,-1, 0, 1, 0/
      DATA (NHEL(I,6),I=0,6) /14,-1, 1,-1, 0,-1, 0/
      DATA (NHEL(I,7),I=0,6) /15,-1, 1, 1, 0, 1, 0/
      DATA (NHEL(I,8),I=0,6) /16,-1, 1, 1, 0,-1, 0/
      DATA IDEN/36/
...
C     ----------
     ...
     $14))  !  count 4
      CALL FFV1P0_3(W(1,1),W(1,4),GC_11(IVEC),ZERO,FK_ZERO,W(1,15))  !  count 4
      CALL FFV1P0_3(W(1,2),W(1,3),GC_11(IVEC),ZERO,FK_ZERO,W(1,16))  !  count 4
      CALL FFV1P1N_1(W(1,8), W(1,15), GC_11(IVEC), TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/13,14/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,8), W(1,16), GC_11(IVEC), TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/13,14/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,9), W(1,15), GC_11(IVEC), TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/13,14/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,9), W(1,16), GC_11(IVEC), TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/13,14/),
