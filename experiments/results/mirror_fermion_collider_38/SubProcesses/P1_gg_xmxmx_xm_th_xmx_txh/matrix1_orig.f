...
C     common/TO_CHANNEL_STRAT/tmin_for_channel,	sde_strat
      ...
      DATA ISHEL/0/
      SAVE YFRAC
      DATA (NHEL(I,   1),I=1,6) /-1,-1,-1, 0, 1, 0/
      DATA (NHEL(I,   2),I=1,6) /-1,-1,-1, 0,-1, 0/
      DATA (NHEL(I,   3),I=1,6) /-1,-1, 1, 0, 1, 0/
      DATA (NHEL(I,   4),I=1,6) /-1,-1, 1, 0,-1, 0/
      DATA (NHEL(I,   5),I=1,6) /-1, 1,-1, 0, 1, 0/
      DATA (NHEL(I,   6),I=1,6) /-1, 1,-1, 0,-1, 0/
      DATA (NHEL(I,   7),I=1,6) /-1, 1, 1, 0, 1, 0/
      DATA (NHEL(I,   8),I=1,6) /-1, 1, 1, 0,-1, 0/
      DATA (NHEL(I,   9),I=1,6) / 1,-1,-1, 0, 1, 0/
      DATA (NHEL(I,  10),I=1,6) / 1,-1,-1, 0,-1, 0/
      DATA (NHEL(I,  11),I=1,6) / 1,-1, 1, 0, 1, 0/
      DATA (NHEL(I,  12),I=1,6) / 1,-1, 1, 0,-1, 0/
      DATA (NHEL(I,  13),I=1,6) / 1, 1,-1, 0, 1, 0/
      DATA (NHEL(I,  14),I=1,6) / 1, 1,-1, 0,-1, 0/
      DATA (NHEL(I,  15),I=1,6) / 1, 1, 1, 0, 1, 0/
      DATA (NHEL(I,  16),I=1,6) / 1, 1, 1, 0,-1, 0/
      DATA IDEN/256/
...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WXM)
      ...
      CALL FFS4_1(W(1,3),W(1,4),GC_HIGGSPORTAL,MDL_MXM, FK_MDL_WXM,W(1
     $ ,5))
      CALL IXXXXX(P(0,5),MDL_MT,NHEL(5),-1*IC(5),W(1,4))
      CALL SXXXXX(P(0,6),+1*IC(6),W(1,3))
      CALL FFS4_2(W(1,4),W(1,3),GC_HIGGSPORTAL,MDL_MXM, FK_MDL_WXM,W(1
     $ ,6))
      CALL VVV1P0_1(W(1,1),W(1,2),GC_10(IVEC),ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,6),W(1,5),W(1,3),GC_11(IVEC),AMP(1))
      CALL FFV1_1(W(1,5),W(1,1),GC_11(IVEC),MDL_MXM, ZERO,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,6),W(1,3),W(1,2),GC_11(IVEC),AMP(2))
      CALL FFV1_2(W(1,6),W(1,1),GC_11(IVEC),MDL_MXM, ZERO,W(1,3))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,3),W(1,5),W(1,2),GC_11(IVEC),AMP(3))
