...
C     
C     Process: g g > xm xm~ WEIGHTED<=2 @1
C     *   Decay: xm > t h WEIGHTED<=2
C     *   Decay: xm~ > t~ h WEIGHTED<=2
C     
      IMPLICIT NONE
C     
...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,1),I=0,6) /1,-1,-1,-1, 0, 1, 0/
      DATA (NHEL(I,2),I=0,6) /2,-1,-1,-1, 0,-1, 0/
      DATA (NHEL(I,3),I=0,6) /3,-1,-1, 1, 0, 1, 0/
      DATA (NHEL(I,4),I=0,6) /4,-1,-1, 1, 0,-1, 0/
      DATA (NHEL(I,5),I=0,6) /5,-1, 1,-1, 0, 1, 0/
      DATA (NHEL(I,6),I=0,6) /6,-1, 1,-1, 0,-1, 0/
      DATA (NHEL(I,7),I=0,6) /7,-1, 1, 1, 0, 1, 0/
      DATA (NHEL(I,8),I=0,6) /8,-1, 1, 1, 0,-1, 0/
      DATA (NHEL(I,9),I=0,6) /9, 1,-1,-1, 0, 1, 0/
      DATA (NHEL(I,10),I=0,6) /10, 1,-1,-1, 0,-1, 0/
      DATA (NHEL(I,11),I=0,6) /11, 1,-1, 1, 0, 1, 0/
      DATA (NHEL(I,12),I=0,6) /12, 1,-1, 1, 0,-1, 0/
      DATA (NHEL(I,13),I=0,6) /13, 1, 1,-1, 0, 1, 0/
      DATA (NHEL(I,14),I=0,6) /14, 1, 1,-1, 0,-1, 0/
      DATA (NHEL(I,15),I=0,6) /15, 1, 1, 1, 0, 1, 0/
      DATA (NHEL(I,16),I=0,6) /16, 1, 1, 1, 0,-1, 0/
      DATA IDEN/256/
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WT) 
        ...
        IF(mdl_WXm.ne.0d0) then 
          fk_mdl_WXm = SIGN(MAX(ABS(mdl_WXm), ABS(mdl_MXm
     $     *small_width_treatment)), mdl_WXm) 
        else 
          fk_mdl_WXm = 0d0
        endif
      ...
      CALL VXXXXX(P(0,2),ZERO,+1,-1*IC(2),W(1,3))  !  count 18
      CALL VXXXXX(P(0,2),ZERO,-1,-1*IC(2),W(1,4))  !  count 18
      CALL OXXXXX(P(0,3),MDL_MT,+1,+1*IC(3),W(1,5))  !  count 1
      CALL OXXXXX(P(0,3),MDL_MT,-1,+1*IC(3),W(1,6))  !  count 1
      CALL SXXXXX(P(0,4),+1*IC(4),W(1,7))  !  count 2
      CALL FFS4_1(W(1,5),W(1,7),GC_HIGGSPORTAL,MDL_MXM,FK_MDL_WXM,W(1,8)
     $)  !  count 18
      CALL FFS4_1(W(1,6),W(1,7),GC_HIGGSPORTAL,MDL_MXM,FK_MDL_WXM,W(1,9)
     $)  !  count 18
      CALL IXXXXX(P(0,5),MDL_MT,+1,-1*IC(5),W(1,10))  !  count 1
      CALL IXXXXX(P(0,5),MDL_MT,-1,-1*IC(5),W(1,11))  !  count 1
      CALL SXXXXX(P(0,6),+1*IC(6),W(1,12))  !  count 2
      CALL FFS4_2(W(1,10),W(1,12),GC_HIGGSPORTAL,MDL_MXM,FK_MDL_WXM,W(1,
     $13))  !  count 18
      CALL FFS4_2(W(1,11),W(1,12),GC_HIGGSPORTAL,MDL_MXM,FK_MDL_WXM,W(1,
     $14))  !  count 18
      CALL VVV1P0_1(W(1,1),W(1,3),GC_10(IVEC),ZERO,FK_ZERO,W(1,15))  !  count 4
      CALL VVV1P0_1(W(1,1),W(1,4),GC_10(IVEC),ZERO,FK_ZERO,W(1,16))  !  count 4
      CALL VVV1P0_1(W(1,2),W(1,3),GC_10(IVEC),ZERO,FK_ZERO,W(1,17))  !  count 4
      CALL VVV1P0_1(W(1,2),W(1,4),GC_10(IVEC),ZERO,FK_ZERO,W(1,18))  !  count 4
      CALL FFV1P1N_3(W(1,13), W(1,8), GC_11(IVEC), TMP(1))
      call CombineAmp(4,
     & (/15,11,7,3/), 
     & (/15,16,17,18/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_3(W(1,13), W(1,9), GC_11(IVEC), TMP(1))
      call CombineAmp(4,
     & (/13,9,5,1/), 
     & (/15,16,17,18/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_3(W(1,14), W(1,8), GC_11(IVEC), TMP(1))
      call CombineAmp(4,
     & (/16,12,8,4/), 
     & (/15,16,17,18/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_3(W(1,14), W(1,9), GC_11(IVEC), TMP(1))
      call CombineAmp(4,
     & (/14,10,6,2/), 
     & (/15,16,17,18/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1_1(W(1,8),W(1,1),GC_11(IVEC),MDL_MXM,ZERO,W(1,19))  !  count 4
      CALL FFV1_1(W(1,8),W(1,2),GC_11(IVEC),MDL_MXM,ZERO,W(1,20))  !  count 4
      CALL FFV1_1(W(1,9),W(1,1),GC_11(IVEC),MDL_MXM,ZERO,W(1,21))  !  count 4
      CALL FFV1_1(W(1,9),W(1,2),GC_11(IVEC),MDL_MXM,ZERO,W(1,22))  !  count 4
      CALL FFV1P1N_2(W(1,13), W(1,3), GC_11(IVEC), TMP(1))
      call CombineAmp(4,
     & (/15,7,13,5/), 
     & (/19,20,21,22/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_2(W(1,13), W(1,4), GC_11(IVEC), TMP(1))
      call CombineAmp(4,
     & (/11,3,9,1/), 
     & (/19,20,21,22/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_2(W(1,14), W(1,3), GC_11(IVEC), TMP(1))
      call CombineAmp(4,
     & (/16,8,14,6/), 
     & (/19,20,21,22/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_2(W(1,14), W(1,4), GC_11(IVEC), TMP(1))
      call CombineAmp(4,
     & (/12,4,10,2/), 
     & (/19,20,21,22/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV1_2(W(1,13),W(1,1),GC_11(IVEC),MDL_MXM,ZERO,W(1,23))  !  count 4
      CALL FFV1_2(W(1,13),W(1,2),GC_11(IVEC),MDL_MXM,ZERO,W(1,24))  !  count 4
      CALL FFV1_2(W(1,14),W(1,1),GC_11(IVEC),MDL_MXM,ZERO,W(1,25))  !  count 4
      CALL FFV1_2(W(1,14),W(1,2),GC_11(IVEC),MDL_MXM,ZERO,W(1,26))  !  count 4
      CALL FFV1P1N_1(W(1,8), W(1,3), GC_11(IVEC), TMP(1))
      call CombineAmp(4,
     & (/15,7,16,8/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_1(W(1,8), W(1,4), GC_11(IVEC), TMP(1))
      call CombineAmp(4,
     & (/11,3,12,4/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_1(W(1,9), W(1,3), GC_11(IVEC), TMP(1))
      call CombineAmp(4,
     & (/13,5,14,6/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_1(W(1,9), W(1,4), GC_11(IVEC), TMP(1))
      call CombineAmp(4,
     & (/9,1,10,2/), 
     & (/23,24,25,26/),
