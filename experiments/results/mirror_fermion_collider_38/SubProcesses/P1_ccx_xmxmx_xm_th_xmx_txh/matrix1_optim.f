...
C     
C     Process: c c~ > xm xm~ WEIGHTED<=2 @1
...
C     ----------
     ...
     $14))  !  count 8
      CALL FFV1P0_3(W(1,1),W(1,3),GC_11(IVEC),ZERO,FK_ZERO,W(1,15))  !  count 4
      CALL FFV1P0_3(W(1,1),W(1,4),GC_11(IVEC),ZERO,FK_ZERO,W(1,16))  !  count 4
      CALL FFV1P0_3(W(1,2),W(1,3),GC_11(IVEC),ZERO,FK_ZERO,W(1,17))  !  count 4
      CALL FFV1P0_3(W(1,2),W(1,4),GC_11(IVEC),ZERO,FK_ZERO,W(1,18))  !  count 4
