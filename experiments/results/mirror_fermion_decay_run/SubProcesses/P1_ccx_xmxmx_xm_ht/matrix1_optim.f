...
C     ----------
     ...
     $)  !  count 8
      CALL IXXXXX(P(0,5),MDL_MXM,+1,-1*IC(5),W(1,10))  !  count 8
      CALL IXXXXX(P(0,5),MDL_MXM,-1,-1*IC(5),W(1,11))  !  count 8
      CALL FFV1P0_3(W(1,1),W(1,3),GC_11(IVEC),ZERO,FK_ZERO,W(1,12))  !  count 4
      CALL FFV1P0_3(W(1,1),W(1,4),GC_11(IVEC),ZERO,FK_ZERO,W(1,13))  !  count 4
      CALL FFV1P0_3(W(1,2),W(1,3),GC_11(IVEC),ZERO,FK_ZERO,W(1,14))  !  count 4
      CALL FFV1P0_3(W(1,2),W(1,4),GC_11(IVEC),ZERO,FK_ZERO,W(1,15))  !  count 4
