...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,1),I=0,5) /1,-1,-1, 0,-1, 1/
      DATA (NHEL(I,2),I=0,5) /2,-1,-1, 0,-1,-1/
      DATA (NHEL(I,3),I=0,5) /3,-1,-1, 0, 1, 1/
      DATA (NHEL(I,4),I=0,5) /4,-1,-1, 0, 1,-1/
      DATA (NHEL(I,5),I=0,5) /5,-1, 1, 0,-1, 1/
      DATA (NHEL(I,6),I=0,5) /6,-1, 1, 0,-1,-1/
      DATA (NHEL(I,7),I=0,5) /7,-1, 1, 0, 1, 1/
      DATA (NHEL(I,8),I=0,5) /8,-1, 1, 0, 1,-1/
      DATA (NHEL(I,9),I=0,5) /9, 1,-1, 0,-1, 1/
      DATA (NHEL(I,10),I=0,5) /10, 1,-1, 0,-1,-1/
      DATA (NHEL(I,11),I=0,5) /11, 1,-1, 0, 1, 1/
      DATA (NHEL(I,12),I=0,5) /12, 1,-1, 0, 1,-1/
      DATA (NHEL(I,13),I=0,5) /13, 1, 1, 0,-1, 1/
      DATA (NHEL(I,14),I=0,5) /14, 1, 1, 0,-1,-1/
      DATA (NHEL(I,15),I=0,5) /15, 1, 1, 0, 1, 1/
      DATA (NHEL(I,16),I=0,5) /16, 1, 1, 0, 1,-1/
      DATA IDEN/256/
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WXm) 
      ...
      CALL SXXXXX(P(0,3),+1*IC(3),W(1,5))  !  count 2
      CALL OXXXXX(P(0,4),MDL_MT,+1,+1*IC(4),W(1,6))  !  count 1
      CALL OXXXXX(P(0,4),MDL_MT,-1,+1*IC(4),W(1,7))  !  count 1
      CALL FFS4_1(W(1,6),W(1,5),GC_HIGGSPORTAL,MDL_MXM,FK_MDL_WXM,W(1,8)
     $)  !  count 18
      CALL FFS4_1(W(1,7),W(1,5),GC_HIGGSPORTAL,MDL_MXM,FK_MDL_WXM,W(1,9)
     $)  !  count 18
      CALL IXXXXX(P(0,5),MDL_MXM,+1,-1*IC(5),W(1,10))  !  count 18
      CALL IXXXXX(P(0,5),MDL_MXM,-1,-1*IC(5),W(1,11))  !  count 18
      CALL VVV1P0_1(W(1,1),W(1,3),GC_10(IVEC),ZERO,FK_ZERO,W(1,12))  !  count 4
      CALL VVV1P0_1(W(1,1),W(1,4),GC_10(IVEC),ZERO,FK_ZERO,W(1,13))  !  count 4
      CALL VVV1P0_1(W(1,2),W(1,3),GC_10(IVEC),ZERO,FK_ZERO,W(1,14))  !  count 4
      CALL VVV1P0_1(W(1,2),W(1,4),GC_10(IVEC),ZERO,FK_ZERO,W(1,15))  !  count 4
      CALL FFV1P1N_3(W(1,10), W(1,8), GC_11(IVEC), TMP(1))
      call CombineAmp(4,
     & (/15,11,7,3/), 
     & (/12,13,14,15/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_3(W(1,10), W(1,9), GC_11(IVEC), TMP(1))
      call CombineAmp(4,
     & (/13,9,5,1/), 
     & (/12,13,14,15/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_3(W(1,11), W(1,8), GC_11(IVEC), TMP(1))
      call CombineAmp(4,
     & (/16,12,8,4/), 
     & (/12,13,14,15/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_3(W(1,11), W(1,9), GC_11(IVEC), TMP(1))
      call CombineAmp(4,
     & (/14,10,6,2/), 
     & (/12,13,14,15/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1_1(W(1,8),W(1,1),GC_11(IVEC),MDL_MXM,ZERO,W(1,16))  !  count 4
      CALL FFV1_1(W(1,8),W(1,2),GC_11(IVEC),MDL_MXM,ZERO,W(1,17))  !  count 4
      CALL FFV1_1(W(1,9),W(1,1),GC_11(IVEC),MDL_MXM,ZERO,W(1,18))  !  count 4
      CALL FFV1_1(W(1,9),W(1,2),GC_11(IVEC),MDL_MXM,ZERO,W(1,19))  !  count 4
      CALL FFV1P1N_2(W(1,10), W(1,3), GC_11(IVEC), TMP(1))
      call CombineAmp(4,
     & (/15,7,13,5/), 
     & (/16,17,18,19/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_2(W(1,10), W(1,4), GC_11(IVEC), TMP(1))
      call CombineAmp(4,
     & (/11,3,9,1/), 
     & (/16,17,18,19/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_2(W(1,11), W(1,3), GC_11(IVEC), TMP(1))
      call CombineAmp(4,
     & (/16,8,14,6/), 
     & (/16,17,18,19/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_2(W(1,11), W(1,4), GC_11(IVEC), TMP(1))
      call CombineAmp(4,
     & (/12,4,10,2/), 
     & (/16,17,18,19/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV1_2(W(1,10),W(1,1),GC_11(IVEC),MDL_MXM,ZERO,W(1,20))  !  count 4
      CALL FFV1_2(W(1,10),W(1,2),GC_11(IVEC),MDL_MXM,ZERO,W(1,21))  !  count 4
      CALL FFV1_2(W(1,11),W(1,1),GC_11(IVEC),MDL_MXM,ZERO,W(1,22))  !  count 4
      CALL FFV1_2(W(1,11),W(1,2),GC_11(IVEC),MDL_MXM,ZERO,W(1,23))  !  count 4
