...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,5),I=0,5) /13,-1, 1, 0,-1, 1/
      DATA (NHEL(I,6),I=0,5) /14,-1, 1, 0,-1,-1/
      DATA (NHEL(I,7),I=0,5) /15,-1, 1, 0, 1, 1/
      DATA (NHEL(I,8),I=0,5) /16,-1, 1, 0, 1,-1/
      DATA IDEN/36/
...
C     ----------
     ...
     $)  !  count 4
      CALL IXXXXX(P(0,5),MDL_MXM,+1,-1*IC(5),W(1,10))  !  count 4
      CALL IXXXXX(P(0,5),MDL_MXM,-1,-1*IC(5),W(1,11))  !  count 4
      CALL FFV1P0_3(W(1,1),W(1,4),GC_11(IVEC),ZERO,FK_ZERO,W(1,12))  !  count 4
      CALL FFV1P0_3(W(1,2),W(1,3),GC_11(IVEC),ZERO,FK_ZERO,W(1,13))  !  count 4
      CALL FFV1P1N_1(W(1,8), W(1,12), GC_11(IVEC), TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/10,11/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,8), W(1,13), GC_11(IVEC), TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/10,11/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,9), W(1,12), GC_11(IVEC), TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/10,11/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,9), W(1,13), GC_11(IVEC), TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/10,11/),
