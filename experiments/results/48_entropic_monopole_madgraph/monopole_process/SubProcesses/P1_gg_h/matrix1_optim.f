...
C     
C     Process: g g > h HIG<=1 HIW<=1 WEIGHTED<=2 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,1),I=0,3) /1,-1,-1, 0/
      DATA (NHEL(I,2),I=0,3) /4, 1, 1, 0/
      DATA IDEN/256/
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WH) 
      ...
      CALL VVS3_0(W(1,1),W(1,3),W(1,5),GC_13(IVEC),AMP(2,1))
      CALL VVS3_0(W(1,2),W(1,4),W(1,5),GC_13(IVEC),AMP(1,1))  !  count 1
