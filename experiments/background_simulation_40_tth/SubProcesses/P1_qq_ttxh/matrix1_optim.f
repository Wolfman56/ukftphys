...
C     
C     Process: u u~ > t t~ h WEIGHTED<=4 @1
C     Process: c c~ > t t~ h WEIGHTED<=4 @1
C     Process: d d~ > t t~ h WEIGHTED<=4 @1
C     Process: s s~ > t t~ h WEIGHTED<=4 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,5),I=0,5) /13,-1, 1,-1, 1, 0/
      DATA (NHEL(I,6),I=0,5) /14,-1, 1,-1,-1, 0/
      DATA (NHEL(I,7),I=0,5) /15,-1, 1, 1, 1, 0/
      DATA (NHEL(I,8),I=0,5) /16,-1, 1, 1,-1, 0/
      DATA IDEN/36/
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WT) 
      ...
      CALL OXXXXX(P(0,3),MDL_MT,+1,+1*IC(3),W(1,5))  !  count 5
      CALL OXXXXX(P(0,3),MDL_MT,-1,+1*IC(3),W(1,6))  !  count 5
      CALL IXXXXX(P(0,4),MDL_MT,+1,-1*IC(4),W(1,7))  !  count 5
      CALL IXXXXX(P(0,4),MDL_MT,-1,-1*IC(4),W(1,8))  !  count 5
      CALL SXXXXX(P(0,5),+1*IC(5),W(1,9))  !  count 4
      CALL FFV1P0_3(W(1,1),W(1,4),GC_11(IVEC),ZERO,FK_ZERO,W(1,10))  !  count 8
      CALL FFV1P0_3(W(1,2),W(1,3),GC_11(IVEC),ZERO,FK_ZERO,W(1,11))  !  count 8
      CALL FFS4_1(W(1,5),W(1,9),GC_94,MDL_MT,FK_MDL_WT,W(1,12))  !  count 4
      CALL FFS4_1(W(1,6),W(1,9),GC_94,MDL_MT,FK_MDL_WT,W(1,13))  !  count 4
      CALL FFV1P1N_1(W(1,12), W(1,10), GC_11(IVEC), TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,12), W(1,11), GC_11(IVEC), TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,13), W(1,10), GC_11(IVEC), TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,13), W(1,11), GC_11(IVEC), TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFS4_2(W(1,7),W(1,9),GC_94,MDL_MT,FK_MDL_WT,W(1,14))  !  count 4
      CALL FFS4_2(W(1,8),W(1,9),GC_94,MDL_MT,FK_MDL_WT,W(1,15))  !  count 4
      CALL FFV1P1N_1(W(1,5), W(1,10), GC_11(IVEC), TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/14,15/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_1(W(1,5), W(1,11), GC_11(IVEC), TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/14,15/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_1(W(1,6), W(1,10), GC_11(IVEC), TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/14,15/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_1(W(1,6), W(1,11), GC_11(IVEC), TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/14,15/),
...
C       JAMPs contributing to orders ALL_ORDERS=1
        ...
        JAMP(1,1) = (1.666666666666667D-01)*TMP_JAMP(1)
