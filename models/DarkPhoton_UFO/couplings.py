...
# ── Dark Photon couplings (kinetic mixing: Ap couples like epsilon*photon) ───
GC_Ap_dn = Coupling(name = 'GC_Ap_dn',
                    value = '-(epsilon*ee*complex(0,1))/3.',
                    order = {'QED':1})

GC_Ap_up = Coupling(name = 'GC_Ap_up',
                    value = '(2*epsilon*ee*complex(0,1))/3.',
                    order = {'QED':1})

GC_Ap_mu = Coupling(name = 'GC_Ap_mu',
                    value = '-(epsilon*ee*complex(0,1))',
                    order = {'QED':1})
