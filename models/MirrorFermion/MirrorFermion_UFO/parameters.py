...
epsilon = Parameter(name = 'epsilon', nature = 'external', type = 'real', value = 0.001, texname = '\\epsilon', lhablock = 'FRBLOCK', lhacode = [ 2 ])

gRefl = Parameter(name = 'gRefl', nature = 'external', type = 'real', value = 0.1, texname = 'g_{Refl}', lhablock = 'FRBLOCK', lhacode = [ 3 ])